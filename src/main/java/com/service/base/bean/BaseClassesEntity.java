...
public class BaseClassesEntity {
	...
	private String flag_tea = "";
	private String flag_stu = "";
	private String bjteano = "";
	private String bjstuno = "";
	...
	public String getFlag_tea() {
		return flag_tea;
	}

	public void setFlag_tea(String flag_tea) {
		this.flag_tea = flag_tea;
	}

	public String getFlag_stu() {
		return flag_stu;
	}

	public void setFlag_stu(String flag_stu) {
		this.flag_stu = flag_stu;
	}

	public String getBjteano() {
		return bjteano;
	}

	public void setBjteano(String bjteano) {
		this.bjteano = bjteano;
	}

	public String getBjstuno() {
		return bjstuno;
	}

	public void setBjstuno(String bjstuno) {
		this.bjstuno = bjstuno;
	}
