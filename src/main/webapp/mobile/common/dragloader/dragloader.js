(function(window, document, exportName, undefined) {
	 ...
	 */
	function monitorEvent(el,type, fn, capture) {
    ...
    var DragLoader = function(el, options) {
        this.el = el ? (typeof el === 'string' ? document.querySelector(el) : el) : document.body;
        options = options || {};
        ...
        this.el.addEventListener(touchEvents.start, this, false);
    };
    ...
    DragLoader.prototype = {
        ...
        _createDragDownRegion: function() {
            ...
            this.el.insertBefore(this.header, this.el.children[0]);
            return this.header;
        },
        ...
        _removeDragUpRegion: function() {
            if (this.footer) {
                this.el.removeChild(this.footer);
                this.footer = null;
            }
        },
        ...
        _processStatus: function(orient, offsetY, currentStatus, moved) {
            var options = this.options,status = this.status,
            ...
            if (orient) {
                ...
                if (!overflow && currentStatus != status.defaults) {
                    this['_processDrag' + upperStr + 'Helper'].call(this, status.defaults);
                    this._fireEvent('drag' + upperStr + 'Default');
                    nextStatus = status.defaults;
                ...
                } else if (!moved && overflow && currentStatus != status.loading) {
                    this['_processDrag' + upperStr + 'Helper'].call(this, status.loading);
        ...
        _onTouchStrat: function(e) {
            this.el.removeEventListener(touchEvents.move, this, false);
            this.el.removeEventListener(touchEvents.end, this, false);
            var body = document.body,
                startScrollY = this.el === body ? (window.pageYOffset || window.scrollY || document.documentElement.scrollTop) : this.el.scrollTop;
            if (this._draggable && (this.options.disableDragDown !== true || this.options.disableDragUp !== true) && this._fireEvent('beforeDrag') !== false) {
                ...
                this.el.addEventListener(touchEvents.move, this, false);
                this.el.addEventListener(touchEvents.end, this, false);
                this._touchCoords = {};
        ...
        _onTouchMove: function(e) {
            var el = this.el, header = this.header, footer = this.footer,
                options = this.options,
                innerHeight = window.innerHeight,
                ctHeight = el.scrollHeight,
            ...
            if (coords.canDragDown && coords.dragUp !== true && (coords.dragDown || startY - stopY + startScrollY < 0)) {
                ...
                el.scrollTop = startScrollY + offsetY;
        ...
        _translate: function() {
            var me = this,
                ...
                endFn = function() {
                    ...
                    if (!orient || coords.status !== me.status.loading) {
        ...
        destroy: function() {
            if (!this.destroyed) {
                ...
                this._removeDragDownRegion();
                this._removeDragUpRegion();
                this.el.removeEventListener(touchEvents.start, this, false);
                this.el.removeEventListener(touchEvents.move, this, false);
                this.el.removeEventListener(touchEvents.end, this, false);
                this.el = null;
            }
    ...
    if (typeof define == "function" && define.amd) {
	    ...
	    module.exports = DragLoader;
	} else {
	    window[exportName] = DragLoader;
	}
})(window, document, 'DragLoader');